...
transform = transforms.Compose([
    transforms.Resize((256, 256)),  # Spremenimo velikost slike na 256x256 pikslov
...
def classify_species():
    ...
    probabilities = species_model(table, ret=Orange.classification.Classifier.Probs)[0]  # Dobimo verjetnosti
